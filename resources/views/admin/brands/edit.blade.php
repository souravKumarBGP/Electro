            ...
            <div class="container-fluid">
                <div class="row mb-2 align-items-center">
                    ...
                    <div class="col-sm-6" class="position-relative">
                        <span style="font-size: 23px; margin-right:5px;">Edit Brand</span>
                    </div><!-- /.col -->
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            <form class="col-7" action="{{ route("admin.brands.update", $data->brandId) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="brandName" value="{{ $data->name }}" id="brandName" class="form-control @error('brandName') is-invalid @enderror " />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="metaTitle" value="{{ $data->metaTitle }}" id="metaTitle" class="form-control @error('metaTitle') is-invalid @enderror " />
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="metaDiscreption" class="form-control @error('metaDiscreption') is-invalid @enderror" id="metaDiscreption" rows="3"> {{ $data->metaDiscreption }} </textarea>
