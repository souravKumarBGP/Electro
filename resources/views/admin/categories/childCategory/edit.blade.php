            ...
            <div class="container-fluid">
                <div class="row mb-2 align-items-center">
                    ...
                    <div class="col-sm-6" class="position-relative">
                        <span style="font-size: 23px; margin-right:5px;">Edit child category</span>
                    </div><!-- /.col -->
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            <form class="col-7" action="{{ route("childcategories.update", $data->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="childCategoryName" value="{{ $data->childCategoryName }}" id="childCategoryName" class="form-control @error('childCategoryName') is-invalid @enderror " />
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="categoryName" class="form-select form-control  @error('categoryName') is-invalid @enderror ">
                                            ...
                                            @foreach ($parentCategory as $items)
                                                <option value="{{ $items->categoryName }}" {{ ($items->categoryName == $data->categoryName ) ? "selected" : "" }} >{{ $items->categoryName }}</option>
                                            @endforeach
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="discreption" class="form-control @error('discreption') is-invalid @enderror" id="discreption" rows="3"> {{ $data->discreption }} </textarea>
