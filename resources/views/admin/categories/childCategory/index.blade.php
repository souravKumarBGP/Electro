            ...
            <div class="container-fluid">
                <div class="row mb-2 align-items-center">
                    ...
                    <div class="col-sm-6" class="position-relative">
                        <span style="font-size: 23px; margin-right:5px;">All child categories</span>
                    </div><!-- /.col -->

                    <div class="col-sm-6" style="text-align: end;">
                        <a href="{{ route("childcategories.create") }}" class="btn btn-primary px-4 rounded-0">New child category</a>
                    </div><!-- /.col -->
                                ...
                                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                    ...
                                    <div class="row justify-content-between">
                                        <div class="card-eader">
                                            <h6 class="card-ttle"><big>List of all child categories</big></h6>
                                        </div>
                                        <div>
                                            <div id="" class="d-flex">
                                            ...
                                            <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"   style="widt: 1500px;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="sorting sorting_asc"> Parent Category </th>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($data as $items)
                                                        <tr>
                                                            ...
                                                            <td style="width: 200px;">{{ $items->childCategoryName }}</td>
                                                            <td style="width: 250px;"> {{ $items->discreption }} </td>
                                                            <td> {{ $items->categoryName }} </td>
                                                            <td><img src="{{ asset("storage/".$items->categoryImage) }}" width="50" alt=""></td>
                                                            <td style="width: 250px; border:none;" class="d-flex justify-content-between">
                                                                ...
                                                                <a onclick="return confirm('Are you sure edit this category')" href="{{ route("childcategories.edit", $items->id) }}" class="mx-2">
                                                                ...
                                                                <a href="#" onclick="return confirm('Are you sure you want to delete this category')">
                                                                    ...
                                                                    <form action="{{ route("childcategories.destroy", $items->id) }}" method="POST" class="border-none">
