            ...
            <div class="container-fluid">
                <div class="row mb-2 align-items-center">
                    ...
                    <div class="col-sm-6" style="text-align: end;">
                        <a href="{{ route("admin.createCategory") }}" class="btn btn-primary px-4 rounded-0">New Category</a>
                    </div><!-- /.col -->
                                ...
                                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                    ...
                                    <div class="row justify-content-between">
                                        <div class="card-eader">
                                            <h6 class="card-ttle"><big>List of all categories</big></h6>
                                        </div>
                                        <div>
                                            <div id="" class="d-flex">
                                                ...
                                                <tbody>
                                                    ...
                                                    @else
                                                        @foreach ($data as $items)
                                                            <tr>
                                                                <td style="width:150px;">{{ $items->categoryId }}</td>
                                                                <td style="width: 150px;">{{ $items->categoryName }}</td>
                                                                <td style="width: 400px;"> {{ $items->discreption }} </td>
                                                                <td><img src="{{ asset("storage/".$items->picture) }}" width="50" alt=""></td>
                                                                <td style="width: 250px; border:none;" class="d-flex justify-content-between">
                                                                    ...
                                                                    <a onclick="return confirm('Are you sure edit this category')" href="{{ route("admin.editCategory", $items->categoryId) }}" class="mx-2">
                                                                    ...
                                                                    <a href="#" onclick="return confirm('Are you sure you want to delete this category')">
                                                                        ...
                                                                        <form action="{{ route("admin.destroyCategory", $items->categoryId) }}" method="POST" class="border-none">
