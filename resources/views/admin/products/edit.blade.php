            ...
            <div class="container-fluid">
                <div class="row mb-2 align-items-center">
                    ...
                    <div class="col-sm-6" class="position-relative">
                        <span style="font-size: 23px; margin-right:5px;">Edit Products</span>
                    </div><!-- /.col -->
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            <form class="col-12" action="{{ route("products.update", $product->productId) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="card-body col-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col mb-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="productName" value="{{$product->productName }}" id="productName" class="form-control @error('productName') is-invalid @enderror " />
                                            ...
                                            <div class="col mb-3">
                                                ...
                                                <select class="custom-select" name="brandName" id="brandName">
                                                    ...
                                                    @foreach ($brandName as $items)
                                                        <option value="{{ $items->name }}" {{ ($items->name == $product->brandName) ? "selected" : "" }}  >{{ $items->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col mb-3">
                                                ...
                                                <input type="text" name="mrp" value="{{ $product->mrp }}" id="mrp" class="form-control @error('mrp') is-invalid @enderror " />
                                            ...
                                            <div class="col mb-3">
                                                ...
                                                <input type="number" name="sellPrice" value="{{ $product->sellPrice }}" id="sellPrice" class="form-control @error('sellPrice') is-invalid @enderror " />
                                            ...
                                            <div class="col mb-3">
                                                ...
                                                <select class="custom-select" name="categoryName" id="categoryName">
                                                    @foreach ($categoryName as $items)
                                                        <option value="{{ $items->categoryName }}" {{ ($items->categoryName == $product->categoryName) ? "selected" : "" }} >{{ $items->categoryName }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col mb-3">
                                                ...
                                                <select class="custom-select" name="childCategoryName" id="childCategoryName">
                                                    ...
                                                    @foreach ($childCategoryName as $items)
                                                        <option value="{{ $items->childCategoryName }}" {{ ($items->childCategoryName == $product->childCategoryName) ? "selected" : "" }} >{{ $items->childCategoryName }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col mb-3">
                                                ...
                                                <select class="custom-select" name="unite" id="unite">
                                                    <option value="Pice" {{ ($product->unit == "Pice") ? "selected" : "" }}>Pice</option>
                                                    <option value="kg" {{ ($product->unit == "kg") ? "selected" : "" }}>KG</option>
                                                    <option value="feet" {{ ($product->unit == "feet") ? "selected" : "" }}>Feet</option>
                                                </select>
                                            ...
                                            <div class="col mb-3">
                                                ...
                                                <input type="number" name="totalQuantity" value="{{ $product->abalibleQuantity }}" class="form-control ms-5  @error('totalQuantity') is-invalid @enderror" id="totalQuantity" />
                                    ...
                                    <div class="col-6 mt-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea  style="width: 100%" name="productDiscreption" class="form-control @error('productDiscreption') is-invalid @enderror" id="productDiscreption" rows="3"> {{ $product->productDiscreption }} </textarea>
