@extends("layoutes.app") {{-- Extends common layoute form layoutes folder --}}

@section("title") About | Electro - Responsive Website Template @endsection {{-- Pass dynamic webpage title --}}
