...
@section("title") Shop | Electro - Responsive Website Template @endsection {{-- Pass dynamicaly page title --}}
                                        ...
                                        <div class="product-item__footer col-md-3 d-md-block">
                                            <div class="mb-3">
                                                ...
                                                <div class="prodcut-add-cart">
                                                    <a href="#" class="btn btn-sm btn-block btn-primary-dark btn-wide transition-3d-hover">Add to cart</a>
                                                </div>
                                            </div>
