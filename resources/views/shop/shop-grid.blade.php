...
@section("title") Shop Grid | Electro - Responsive Website Template @endsection {{-- Pass dynamicaly page title --}}
            ...
            <div class="d-none d-xl-block col-xl-3 col-wd-2gdot5">
                        ...
                        <li>
                            <ul class="list-unstyled">
                                ...
                                @foreach ($childCategoryName as $items)
                                    <a href="#" class="d-flex mb-1"><li style="font-size: 13px;" class="me-5">{{ $items->childCategoryName }}</li> &nbsp;&nbsp; <span>❯</span> </a>
                                @endforeach
                ...
                <div class="mb-6">
                    ...
                    <div class="border-bottom pb-4 mb-4">
                        ...
                        {{-- Generate dynamice brand filter check box --}}
                        <!-- Checkboxes -->
                        @foreach ($brands as $items)

                            <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="brandAdidas{{ $loop->iteration }}">
                                    <label class="custom-control-label" for="brandAdidas{{ $loop->iteration }}">{{ $items->brandName }}
                                        <span class="text-gray-25 font-size-12 font-weight-normal"> ({{ $items->totalBrand }})</span>
                                    </label>
                                </div>
                            </div>
            ...
            <div class="col-xl-9 col-wd-9gdot5">
                ...
                @if ($products->isEmpty())
                    <center>
                        ...
                        <h4 class="text-dark"><b>Sorry, no results found!</b></h4>
                        <h5 class="text-secondary">Please check the spelling or try searching for something else</h5>
                    </center>
                @endif
                ...
                @if (!$products->isEmpty())
                    ...
                    <div class="d-block d-md-flex flex-center-between mb-3">
                        <h3 class="font-size-25 mb-2 mb-md-0">List of all products</h3>
                        <div>
                                        ...
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner px-xl-4 p-3">
                                                <div class="product-item__body pb-xl-2">
                                                    <div class="mb-2"><a href="#" class="font-size-12 text-gray-5">{{ $items->childCategoryName }}</a></div>
                                                    <h5 class="mb-1 product-item__title"><a href="{{ route('shop.single-product-extended', $items->slug) }}" class="text-blue font-weight-bold">{{ $items->productName }}</a></h5>
                                                    <div class="mb-2" style="min-width: 169.6px">
                                                        <a href="{{ route('shop.single-product-extended', $items->slug) }}" class="d-block text-center"><img class="img-fluid" src="{{ asset("storage/".$items->productThemainal) }}" alt="Image Description"></a>
                                                    </div>
                                                    <div class=" d-flex justify-content-between mb-1">
                                                        <div class="prodcut-price">
                                                            <div class="text-gray-100">${{ $items->sellPrice }}</div>
                                                        </div>
